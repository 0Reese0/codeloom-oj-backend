...
/**
* @author ASUS
* @description 针对表【training_category】的数据库操作Service实现
* @createDate 2024-02-01 22:24:42
*/
@Service
public class TrainingCategoryServiceImpl extends ServiceImpl<TrainingCategoryMapper, TrainingCategory>
    implements TrainingCategoryService{
